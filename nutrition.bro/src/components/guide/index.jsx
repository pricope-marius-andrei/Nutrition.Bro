    ...
    return (
        <div>
            <div className='flex items-center justify-between flex-col py-36 bg-white heropattern-ilikefood-green-lime/10 full font-fredoka-medium'>
                ...
                <ListItem id="1">
                    <div className="bg-green p-2 rounded-2xl px-10 py-3 w-48 h-fit bg-gradient-to-r from-grass-green to-green text-white text-center mb-5">SIGN-UP</div>
                </ListItem>
                <ListItem id="2">
                    <div className="bg-green p-2 rounded-2xl px-10 w-48 bg-transparent outline outline-black text-black outline-4 text-center mb-5"><span className="flex justify-center"><Image width={32} src={google}></Image><h1 className="my-auto">Sign-up</h1></span></div>
                </ListItem>
                <ListItem id="3">
                ...
                <ListItem id="4">
                <div className="bg-green p-2 rounded-2xl px-10 py-3 w-48 h-fit bg-gradient-to-r from-grass-green to-green text-white text-center mb-5">ADD FOOD</div>
                </ListItem>
